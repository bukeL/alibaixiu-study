        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-center">
              <a href="posts-edit.php?id=<?php echo $item['post_id'] ?>" class="btn btn-default btn-xs">编辑</a>
              <a href="/admin/post-delete.php?id=<?php echo $item['post_id']; ?>" class="btn btn-danger btn-xs">删除</a>
            </td>
          </tr>
